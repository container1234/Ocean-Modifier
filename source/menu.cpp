...
namespace tesla
{
    ...
    bool OceanModifier::check_if_seed_fixed()
    {
        char inst[8];
    ...
    u32 OceanModifier::read_seed_fixed()
    {
        u32 value = 0;
        u32 inst;
        dmntchtReadCheatProcessMemory(this->base, &inst, sizeof(inst));
    ...
    void OceanModifier::write_game_random_seed(u32 value)
    {
        u32 inst = 0;
    ...
    void OceanModifier::update_seed()
    {
        if (fix_seed_flag)
    ...
    void OceanModifier::restore_game_random_seed()
    {
        constexpr char inst_orig[8] = {0x00, 0x01, 0x40, 0xF9, 0x93, 0xE1, 0x4E, 0x94};
